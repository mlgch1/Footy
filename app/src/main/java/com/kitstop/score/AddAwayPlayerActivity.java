...
public class AddAwayPlayerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addawayplayer);
    ...
    public void finish() {
        ...
        if ((strString1.length() != 0) && (strString2.length() != 0)) {
            myDb.insertPlayerRow(getAwayTeam(), strString1, strString2, 0, 0, 0);
        }

        myDb.K_Log("Add Away Player " + strString1 + " " + strString2);
