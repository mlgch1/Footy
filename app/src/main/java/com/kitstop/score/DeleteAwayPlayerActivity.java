...
public class DeleteAwayPlayerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deleteawayplayer);
    ...
    public void populateListViewFromDB_Away() {
        ...
        list1 = (ListView) findViewById(R.id.away_player_list_1_d);
    ...
    private void registerListClickCallback() {
        ListView list1 = (ListView) findViewById(R.id.away_player_list_1_d);
