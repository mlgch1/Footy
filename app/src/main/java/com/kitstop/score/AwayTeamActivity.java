...
public class AwayTeamActivity extends Activity implements OnMenuItemClickListener {
    DBAdapter myDb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_away_team);
    ...
    public void onClick_AddAwayTeam(View view) {
        Intent intent = new Intent(AwayTeamActivity.this, AddTeamActivity.class);
    ...
    private void populateListViewFromDB() {
        ...
        ListView myList = (ListView) findViewById(R.id.away_team_list);
    ...
    private void registerListClickCallback() {
        ...
        myList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View viewClicked, int position,
                                    long idInDB) {
                lngIdTempDB = idInDB;
                CreatePopupMenu(findViewById(R.id.away_team_list));
            }
        });
    }
    ...
    private void displayAlertDialog() {
        Context context = AwayTeamActivity.this;
    ...
    public boolean onMenuItemClick(MenuItem arg0) {
        switch (arg0.getItemId()) {
            case R.id.option1: {
                setAwayTeam(lngIdTempDB);

                // Update System
                myDb.updateSystem(DBAdapter.KEY_SYSTEM_AWAY_TEAM, (int) lngIdTempDB);
